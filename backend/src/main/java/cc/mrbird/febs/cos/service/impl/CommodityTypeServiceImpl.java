...
public class CommodityTypeServiceImpl extends ServiceImpl<CommodityTypeMapper, CommodityType> implements ICommodityTypeService {
     ...
     */
    @Override
    public IPage<LinkedHashMap<String, Object>> selectRoomTypePage(Page<CommodityType> page, CommodityType commodityType) {
        return baseMapper.selectRoomTypePage(page, commodityType);
    }
}
